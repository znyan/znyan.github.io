...
// 顶部高亮修改： getRealPath true -> false
let links = document.querySelectorAll(".nav-link");
let rootRealPath = getRealPath(window.location.pathname, false); 
...
let mrootRealPath = getRealPath(window.location.pathname, false);
for (let mlink of mlinks) {
  let mlinkPath = mlink.getAttribute("href");
  if (mlinkPath && getRealPath(mlinkPath, false) === mrootRealPath) {
